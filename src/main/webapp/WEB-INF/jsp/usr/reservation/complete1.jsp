...
<div class="breadcrumbs">
	...
	<div class="complete_box">
		<div class="title">귀하께서 신청하신  [12월 학부모아카데미]겨울방학 대비 내 자녀 진로와 학습설계 교육이 <em>정상적으로 접수</em>되었습니다.</div>
		<ul class="bu">
			<li>수강신청이 승인되면 수강료 납부 및 할인관련 증빙서류를 팩스 또는 이메일로 24시간 이내에 반드시 제출 해주셔야 합니다.<br />
				수강료 납부 및 증빙서류가 도착하지 않으면 수강신청이 취소될 수 있습니다.</li>
			<li>수강신청이 승인되면 SMS수신여부 동의 시 별도 안내 예정입니다.</li>
		</ul>
		<p><em class="em_red">※ 예약 신청결과 및 취소, 결제는 “나의예약” 에서 확인하실 수 있습니다.</em></p>
	</div>
	<div class="buttonbox">
		<a href="/yjcareer/usr/mypage/myReservation.do" class="btn type6">나의예약조회</a>
		<a href="/yjcareer/usr/reservation/list1.do" class="btn type7">확인</a>
	</div>
</div>
                    </div>
