...
function fn_excelDownload() {
    ...
    f.action = "${contextRoot}/adm/reservation/wood/downloadExcel.do";
    f.method = "post";
    f.submit();
}
...
<table class="list-1">
	...
	<div class="text-right btn-area">
		<a href="javascript:void(0);" id="btn_apply" class="point" data-url="${contextRoot}/adm/reservation/${programVO.pgType}/applyForm.do?menuId=${menuId}&pgId=${programVO.pgId}&slotDate=${reservationVO.slotDate}">
		   참여자 등록
		</a>
