...
function fn_delete(){
	...
	if(confirm("자료를 삭제하시겠습니까?")){
		var reqUrl = "${contextRoot}/adm/product/delete.do?&memuId="+menuId;
...
function fn_update(){
	...
	var menuId = "${menuId}";
	var reqUrl = "${contextRoot}/adm/product/updateForm.do";
...
function fn_list(){
	...
	var productId = $("#productId").val();
	var menuId = $("#menuId").val();
	var reqUrl = "${contextRoot}/adm/product/list.do?menuId="+menuId
