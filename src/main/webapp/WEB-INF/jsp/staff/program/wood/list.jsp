...
function fn_detail( pgType , pgId){
	...
	var reqUrl = "${contextRoot}/staff/program/"+pgType+"/detail.do?pgId="+pgId+"&menuId="+menuId;
	$("#form").attr("action", reqUrl);
	$("#form").submit();
} 
...
<table class="list-1">
	...
	<div class="text-center">
		...
		<div class="text-right btn-area">
			<a href="${contextRoot }/staff/program/${programVO.pgType}/form.do?menuId=${menuId}">등록</a>
		</div>
	</div>
</section>