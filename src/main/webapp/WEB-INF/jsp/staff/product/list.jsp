...
function fn_search( param1 ){
	...
	var reqUrl = "${contextRoot}/staff/product/list.do?codeId=?"+param1;
...
function fn_detail( param1 ){
	...
	var reqUrl = "${contextRoot}/staff/product/detail.do?productId="+productId;
	$("#form").attr("action", reqUrl);
	$("#form").submit();
}  
...
<div class="text-center">
	...
	<div class="text-right btn-area">
		<a href="${contextRoot}/staff/product/form.do?menuId=${menuId}">등록</a>
	</div>
</div>
</section>