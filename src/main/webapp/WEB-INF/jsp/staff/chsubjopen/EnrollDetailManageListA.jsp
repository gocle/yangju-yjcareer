...
function fn_search(pageIndex) {
	...
	$("#listForm").attr("action", "${contextRoot}/staff/chsubjopen/EnrollDetailManageListA.do");
	$("#listForm").submit();
}
...
function fnEnrollAddUserPopup () {
	...
	var reqUrl = "${contextRoot}/staff/chsearch/popup/UsrManageSearchInsertListA.do";
...
function fnCmdSms() {
	...
	var reqUrl = "${contextRoot}/staff/chsubjopen/popup/SmsSendForm.do";
