...
function fn_search(pageIndex) {
    ...
    let reqUrl = "${contextRoot}/staff/chsubjopen/SubjSeqManageList.do";

    $("#listForm").attr("action", reqUrl);
    $("#listForm").submit();
}

function fnCmdInsertForm() {
	var sgrCd = $("#searchSgrCd").val();
	var cateCd = $("#searchCateCd").val();
	if(sgrCd == "" || cateCd == "") {
		alert("분류 선택 후 등록이 가능합니다.");
		return false;
	}
	
	var menuId = $("#menuId").val();
	let reqUrl = "${contextRoot}/staff/chsubjopen/SubjSeqInsertManageForm.do?menuId="+menuId;
	...
	<form id="listForm" name="listForm" method="post">
		...
		<div class="text-center">
			...
			<div class="text-right btn-area">
				<a href="javascript:;" onclick="fnCmdInsertForm()">등록</a>
			</div> 
		</div>
	</form>
</section>