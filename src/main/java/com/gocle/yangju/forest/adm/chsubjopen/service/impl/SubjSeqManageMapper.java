...
public interface SubjSeqManageMapper {
	...
	String selectSubjSeqCd(SubjSeqManageVo subjSeqManageVo) throws Exception;
	
	void insert(SubjSeqManageVo subjSeqManageVo) throws Exception;
