...
public class StaffMenuController {
	 ...
	 * @throws Exception 
	 */
	@RequestMapping("{memType}/menu/leftMenu.do")
    public String leftMenu(@PathVariable("memType") String memType, HttpServletRequest request, HttpServletResponse response
