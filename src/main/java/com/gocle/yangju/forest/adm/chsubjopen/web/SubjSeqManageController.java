...
@Controller(value = "subjSeqManageController")
public class SubjSeqManageController {
	...
	public String selectSubjSeqManageList(@ModelAttribute("searchVo") SubjSeqManageVo searchVo, ModelMap model) throws Exception {
		...
		return "/adm/chsubjopen/SubjSeqManageList";
	}
	...
	public String subjSeqInsertManageForm(@ModelAttribute("searchVo") SubjSeqManageDefaultVo searchVo
		...
		return "/adm/chsubjopen/SubjSeqInsertManageForm";
	}
	...
	public String subjSeqManageForm(@ModelAttribute("searchVo") SubjSeqManageVo searchVo
		...
		return "/adm/chsubjopen/SubjSeqManageForm";
	}
